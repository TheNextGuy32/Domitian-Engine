...
void PhysicsComp::update(float dt)
{
	...
	//Rotational Movement
	rotational_acceleration = total_torque / mass; //TODO: Calc total torque and moment of inertia
...
void PhysicsComp::addDisplacedForce(Force myForce)
{
	...
	total_torque += distance *  myForce.getForce() * -sin(attached_direction_displacement);
